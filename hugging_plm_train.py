...
from utils.bert_dataset import TextClassificationCollator
from utils.bert_dataset import TextClassificationDataset
from utils.tools import read_text
...
def get_datasets(fn, valid_ratio=.2):
    ...
    # transformer dastaset conversion
...
def main(config):
    ...
    total_batch_size = config.batch_size_per_device * device_num()
